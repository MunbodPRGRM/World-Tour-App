...
import 'package:flutter_application_2/model/request/customer_register_post_request.dart';
import 'package:flutter_application_2/model/response/customer_register_post_res.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  void register() {
    if (passwordCtl.text == confirmPasswordCtl.text) {
      ...
      http
          .post(
            Uri.parse("http://192.168.1.6:3000/customers"),
